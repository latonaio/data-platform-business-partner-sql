...
(
  ...
  CONSTRAINT `DataPlatformBusinessPartnerSupplierFunctionData_fk` FOREIGN KEY (`Supplier`) REFERENCES `data_platform_business_partner_general_data` (`BusinessPartner`)
) ENGINE = InnoDB
