...
(
  ...
  CONSTRAINT `DataPlatformBusinessPartnerCustomerPartnerFunctionData_fk` FOREIGN KEY (`Customer`) REFERENCES `data_platform_business_partner_general_data` (`BusinessPartner`)
) ENGINE = InnoDB
