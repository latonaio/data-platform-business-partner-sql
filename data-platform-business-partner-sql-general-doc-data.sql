...
(
  ...
  `DocIssuerBusinessPartner`       int(12) DEFAULT NULL,
    ...
    CONSTRAINT `DataPlatformBusinessPartnerGeneralPDFDataDocIssuerBusinessPartner_fk` FOREIGN KEY (`DocIssuerBusinessPartner`) REFERENCES `data_platform_business_partner_general_data` (`BusinessPartner`)
