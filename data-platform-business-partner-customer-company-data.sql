CREATE TABLE `data_platform_business_partner_customer_company_data`
(
    ...
    CONSTRAINT `DataPlatformBusinessPartnerCustomerCompanyData_fk` FOREIGN KEY (`Customer`) REFERENCES `data_platform_business_partner_general_data` (`BusinessPartner`)
) ENGINE = InnoDB
