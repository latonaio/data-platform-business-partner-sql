CREATE TABLE `data_platform_business_partner_supplier_company_data`
(
    ...
    CONSTRAINT `DataPlatformBusinessPartnerSupplierCompanyData_fk` FOREIGN KEY (`Supplier`) REFERENCES `data_platform_business_partner_general_data` (`BusinessPartner`)
) ENGINE = InnoDB
