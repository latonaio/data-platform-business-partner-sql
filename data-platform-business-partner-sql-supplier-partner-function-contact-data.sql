...
--`Division`                        varchar(2) NOT NULL,         -- 新規追加
  ...
  PRIMARY KEY (`BusinessPartner`, `Supplier`, `PartnerCounter`, `ContactID`) ,
  CONSTRAINT `DataPlatformBusinessPartnerSupplierPartnerFunctionContactData_fk` FOREIGN KEY (`BusinessPartner`, `Supplier`, `PartnerCounter`, `PartnerFunction`, `PartnerFunctionBusinessPartner`, `DefaultPartner`) REFERENCES `data_platform_business_partner_supplier_partner_function_data` (`BusinessPartner`, `Supplier`, `PartnerCounter`, `PartnerFunction`, `PartnerFunctionBusinessPartner`, `DefaultPartner`)
) ENGINE = InnoDB
