...
(
  ...
  `BPGroup1`                        varchar(6) DEFAULT NULL,
  `BPGroup2`                        varchar(6) DEFAULT NULL,
  `BPGroup3`                        varchar(6) DEFAULT NULL,
  `BPGroup4`                        varchar(6) DEFAULT NULL,
  `BPGroup5`                        varchar(6) DEFAULT NULL,
